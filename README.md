...
- **プレート画像セット** — ウェルごとの生画像タイルをStitchingして表示・調整。
...
4. チャンネルの色・明るさ・ガンマ、Conditions、スケールバー、表示倍率を必要に応じて調整します。
5. 書き出し形式と出力品質を選んで保存します。Stack / time series PDFは撮影フォルダを追加し、収録順を整えてから保存します。
